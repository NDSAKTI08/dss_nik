...
st.write('''Explore workforce dynamics at a glance with this Employee Demography Dashboard. 
         Track hiring trends over time, visualize employee distribution across provinces, and delve into generational 
         and gender insights within departments—all in one comprehensive view.''')
...
col1.write('### Line Plot: Joining Frequency over Time')
...
plot_map = px.scatter_mapbox(data_frame=df_map, lat='latitude', lon='longitude',
                             ...
                             hover_data={'Male': True,
                                         ...
                                         'latitude': False,
                                         'longitude': False})
col2.write('### Map: Employee Count across Indonesia')
